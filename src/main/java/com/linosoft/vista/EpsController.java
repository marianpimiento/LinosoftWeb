...
import com.linosoft.controlador.EpsFacade;
...
public class EpsController implements Serializable {
    ...
    @EJB
    private com.linosoft.controlador.EpsFacade ejbFacade;
...
*/
    public SelectItem[] getItemsAvailableSelectMany() {
        return JsfUtil.getSelectItemsEps(ejbFacade.findAll(), false);
    }

    public SelectItem[] getItemsAvailableSelectOne() {
        return JsfUtil.getSelectItemsEps(ejbFacade.findAll(), true);
    }
