...
import com.linosoft.controlador.CargoFacade;
...
public class CargoController implements Serializable {
    ...
    @EJB
    private com.linosoft.controlador.CargoFacade ejbFacade;
...
*/
    ...
    public SelectItem[] getItemsAvailableSelectMany() {
        return JsfUtil.getSelectItemsCargo(ejbFacade.findAll(), false);
    }

    public SelectItem[] getItemsAvailableSelectOne() {
        return JsfUtil.getSelectItemsCargo(ejbFacade.findAll(), true);
    }    
