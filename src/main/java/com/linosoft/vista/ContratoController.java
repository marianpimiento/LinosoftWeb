...
import com.linosoft.controlador.ContratoFacade;
...
public class ContratoController implements Serializable {
    ...
    @EJB
    private com.linosoft.controlador.ContratoFacade ejbFacade;
...
*/
    ...
    public SelectItem[] getItemsAvailableSelectMany() {
        return JsfUtil.getSelectItemsContrato(ejbFacade.findAll(), false);
    }

    public SelectItem[] getItemsAvailableSelectOne() {
        return JsfUtil.getSelectItemsContrato(ejbFacade.findAll(), true);
    }               
