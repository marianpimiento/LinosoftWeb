...
import com.linosoft.controlador.EmpleadoFacade;
...
public class EmpleadoController implements Serializable {
    ...
    @EJB
    private com.linosoft.controlador.EmpleadoFacade ejbFacade;
...
*/
    public SelectItem[] getItemsAvailableSelectMany() {
        return JsfUtil.getSelectItemsEmpleado(ejbFacade.findAll(), false);
    }

    public SelectItem[] getItemsAvailableSelectOne() {
        return JsfUtil.getSelectItemsEmpleado(ejbFacade.findAll(), true);
    }   
