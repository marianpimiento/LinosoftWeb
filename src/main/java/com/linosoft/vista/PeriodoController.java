...
import com.linosoft.controlador.PeriodoFacade;
...
public class PeriodoController implements Serializable {
    ...
    @EJB
    private com.linosoft.controlador.PeriodoFacade ejbFacade;
...
*/
    ...
    public SelectItem[] getItemsAvailableSelectMany() {
        return JsfUtil.getSelectItemsPeriodo(ejbFacade.findAll(), false);
    }

    public SelectItem[] getItemsAvailableSelectOne() {
        return JsfUtil.getSelectItemsPeriodo(ejbFacade.findAll(), true);
    }       
