...
import com.linosoft.controlador.NovedadFacade;
...
public class NovedadController implements Serializable {
    ...
    @EJB
    private com.linosoft.controlador.NovedadFacade ejbFacade;
    ...
    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("NovedadDeleted"));
        if (!JsfUtil.isValidationFailed()) {
...
*/
    ...
    public SelectItem[] getItemsAvailableSelectMany() {
        return JsfUtil.getSelectItemsNovedad(ejbFacade.findAll(), false);
    }

    public SelectItem[] getItemsAvailableSelectOne() {
        return JsfUtil.getSelectItemsNovedad(ejbFacade.findAll(), true);
    }           
